...
PARAM : tuple[bytes] = (
    ...
    b'-static-pie',
    b'-Wl,-z,norelro',
    b'-Wl,-z,pack-relative-relocs',
    b'-Wl,--hash-style=sysv',
    b'-Wl,-z,noexecstack',
    ...
    b'-Wl,-z,max-page-size=4096',
    b'-Wl,-z,common-page-size=4096',

    b'-Wl,-z,noseparate-code',
    b'-falign-loops=1',
    b'-falign-labels=1',
    b'-falign-jumps=1',
    b'-falign-functions=1',
    b'-fno-jump-tables',
    ...
    b'-fno-reorder-blocks-and-partition',
